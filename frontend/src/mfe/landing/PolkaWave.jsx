...
export default function PolkaWave({ canvasRef: canvasRefProp = null }) {
  const canvasRef = useRef(null);

  useEffect(() => {
    const canvas = canvasRef.current;
    if (canvasRefProp) canvasRefProp.current = canvas;
    return () => {
      if (canvasRefProp) canvasRefProp.current = null;
    };
  }, [canvasRefProp]);
